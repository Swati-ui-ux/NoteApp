...
const PasswordInput = ({ value, onChange, placeholder }) => {
  ...
  return (
      <div className='flex items-center bg-transparent border-[1.5px]  px-5 rounded border-gray-300  mb-3'>
          <input type={showPassword ? "text" : "password"} placeholder={placeholder || "Password"} className='w-full text-sm bg-transparent py-3 mr-3 rounded outline-none' value={value} onChange={onChange} />
